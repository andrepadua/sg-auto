...
, NUM_TELEFONE_CONTATO VARCHAR(30)  COMMENT 'Númeor de Telefone'
, USUARIO VARCHAR(30)  COMMENT 'Usuário de TimeStamp'
, DAT_USUARIO DATETIME  COMMENT 'Data de TimeStamp'
...
, NUM_CNPJ VARCHAR(30) COMMENT 'Número do CNPJ' 
, DSC_RAZAO_SOCIAL VARCHAR(50) COMMENT 'Descriçãoo da Razão Social' 
...
, NUM_AUTONOMIA DECIMAL(14, 2) NOT NULL COMMENT 'Consumo em litros por tipo de combustével' 
, USUARIO VARCHAR(30) COMMENT 'Usuário de TimeStamp' 
, DAT_USUARIO DATETIME COMMENT 'Data de TimeStamp' 
...
ALTER TABLE SGA.CONCESSIONARIA COMMENT 'A fabrica não vendem seus veículos para a rede de concessionárias associada à  marca, não vendendo diretamente para o Usuário final, por isso é necessário saber, a Razão social, CNPJ, endereços, telefones, e os nomes de contato das diversas redes de concessionárias.';
...
ALTER TABLE SGA.PECA COMMENT 'Muitas das peças que compÃµem os carros sÃ£o produzidas por uma rede de fabricantes de peças sendo que para cada tipo de peça pode ser fornecida por mais de um fornecedor.';
...
ALTER TABLE SGA.VEICULO COMMENT 'A XXX montadora de carros produz vários modelos de carros de passeio e de transporte leve.';
