...
, NUM_CNPJ VARCHAR(30) 
, DSC_RAZAO_SOCIAL VARCHAR(50) 
, END_CONCESSIONARIA VARCHAR(100) 
, NOM_CONTATO VARCHAR(60) 
, NUM_TELEFONE_CONTATO VARCHAR(30) 
, USUARIO VARCHAR(30) 
, DAT_USUARIO DATETIME 
...
, SEQ_PECA INT(11) NOT NULL 
, SEQ_VEICULO INT(11) NOT NULL 
, USUARIO VARCHAR(30) COMMENT 'Usuário de TimeStamp' 
, DAT_USUARIO DATETIME COMMENT 'Data de TimeStamp' 
