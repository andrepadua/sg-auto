...
COMMENT ON COLUMN USUARIO.SEQ_USUARIO IS 'Chave Primária da Tabela';
COMMENT ON COLUMN USUARIO.NOM_USUARIO IS 'Nome do Usuário';
COMMENT ON COLUMN USUARIO.LOGINNAME IS 'Login do Usuário';
COMMENT ON COLUMN USUARIO.USUARIO IS 'Usuário de TimeStamp';
COMMENT ON COLUMN USUARIO.DAT_USUARIO IS 'Data de TimeStamp';
