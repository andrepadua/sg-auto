 ...
 * @author Claudio
 */
public class FrmConsVeiculo extends javax.swing.JInternalFrame {

    /**
     * Creates new form FrmConsVeiculo
     */
    public FrmConsVeiculo() throws Exception {
        initComponents();
    ...
    private void PreencherTabela(int SEQ_VEICULO)
            throws Exception {
        DefaultTableModel dtm = new DefaultTableModel();
        dtm.addColumn("Código");
        dtm.addColumn("Nome");
        ...
        dtm.addColumn("Concessionária");
        try {
            ArrayList<Veiculo> lista = vBus.ConsultarSeq(SEQ_VEICULO);
            for (Veiculo v : lista) {
                dtm.addRow(new String[]{
                    String.valueOf(v.getSEQ_VEICULO()),
                    v.getNOM_VEICULO(),
    ...
    private void initComponents() {
        ...
        lblVeiculo.setFont(new java.awt.Font("Century", 0, 18)); // NOI18N
        lblVeiculo.setText("Cód. Veículo:");
