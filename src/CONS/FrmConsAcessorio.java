 ...
 * @author Claudio
 */
public class FrmConsAcessorio extends javax.swing.JInternalFrame {
     ...
     */
    public FrmConsAcessorio() throws Exception {
        initComponents();
    ...
    private void PreencherTabela(int SEQ_ACESSORIO)
            throws Exception {
        ...
        dtm.addColumn("Fornecedor");
        try {
            ArrayList<Acessorio> lista = aBus.ConsultarSeq(SEQ_ACESSORIO);
            for (Acessorio a : lista) {
                dtm.addRow(new String[]{
                    String.valueOf(a.getSEQ_ACESSORIO()),
                    a.getNOM_ACESSORIO(),
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Consultar Acessório");

        jLabel3.setFont(new java.awt.Font("Century", 0, 18)); // NOI18N
        jLabel3.setText("Cód. Acessório:");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addComponent(txtSeq, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
