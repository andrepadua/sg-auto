 ...
 * @author André
 */
public class FrmCadTipoMotorizacao extends javax.swing.JInternalFrame {

    /**
     * Creates new form FrmCadTipoMotorizacao
     */
    public FrmCadTipoMotorizacao() throws Exception {
        initComponents();
        this.pCheckMenu();
        ...
        try {
            ...
            for (TipoMotorizacao tm : lista) {
                dtm.addRow(new String[]{
                    String.valueOf(tm.getSEQ_TIPOMOTORIZACAO()),
                    tm.getDESC_TIPOMOTORIZACAO()
                });
            }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Cadastro de Tipo Motorização");
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        if (!txtSeq.getText().isEmpty()) {
            ...
            if (txtSeq.getText().isEmpty()) {
                ...
                try {
                    Seq = tmBus.Excluir(Integer.parseInt(txtSeq.getText()));
                    if (Seq > 0) {
    ...
    private void btnAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtualizarActionPerformed
        if (fc_verif_campos() == 1) {
            ...
            if (!txtSeq.getText().isEmpty()) {
                ...
                tm.setSEQ_TIPOMOTORIZACAO(Integer.parseInt(txtSeq.getText()));
                tm.setDESC_TIPOMOTORIZACAO(txtNome.getText());
                try {
                    Seq = tmBus.Alterar(tm);
                    if (Seq > 0) {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        if (fc_verif_campos() == 1) {
            int Seq = 0;
            TipoMotorizacao tm = new TipoMotorizacao();
            tm.setSEQ_TIPOMOTORIZACAO(0);
            tm.setDESC_TIPOMOTORIZACAO(txtNome.getText());
            try {
                Seq = tmBus.Incluir(tm);
                if (Seq > 0) {
